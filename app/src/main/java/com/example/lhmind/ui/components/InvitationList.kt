                ...
                invitations.forEach { invitation ->
                    Card(
                        ...
                        Row(
                            ...
                            Column {
                                Text(
                                    text = if (isSent) invitation.playerNameReceiver else invitation.playerNameSender,
                                    style = MaterialTheme.typography.titleMedium
                                )
                                Text(
                                ...
                                /*Text(
                                    text = if (invitation.senderIsMaker && isSent) "Vous devrez créer un code" else if (isSent) "Vous devrez déchiffrer le code" else "Vous devrez créer un code",
                                    style = MaterialTheme.typography.titleMedium
                                )*/
                                Text(
